...
class _CJX_EXT_CLASS CCJThemeHelper  
{
public:
	CCJThemeHelper();
	virtual ~CCJThemeHelper();
...
private:
	...
	static HRESULT __stdcall GetThemeBackgroundContentRectFail(HTHEME, HDC, int, int, const RECT*, RECT*)	{return E_FAIL;}
