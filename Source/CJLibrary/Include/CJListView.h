 ...
 * $Date: 15/12/02 18:03 $
 * $Revision: 4 $
 * $Archive: /Projects/Libraries/CJLibrary/Include/CJListView.h $
 *
 * $History: CJListView.h $
 * 
 * *****************  Version 4  *****************
 * User: Anna         Date: 15/12/02   Time: 18:03
 ...
 * 
 * *****************  Version 2  *****************
 * User: Andy         Date: 2/25/02    Time: 4:45p
 * Updated in $/Projects/Libraries/CJLibrary/Include
 * CCJListCtrl::SetRowColors() and CCJListView::SetRowColors() now take
 * default parameters of value CLR_DEFAULT to allow the text/background
 * colours to be reset to system defaults
 * 
 * *****************  Version 6  *****************
 * User: Ajm          Date: 25/02/02   Time: 11:46
...
//
//*****************  Version 5  *****************
//User: Ajm          Date: 19/10/01   Time: 11:08
//Updated in $/Third Party Software/CJLibrary 6.09/Include
//CJLibrary 6.09 updates
 * 
 * *****************  Version 10  *****************
